...
public class WeeklyNotificationJobService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        LocalNotifications.sendWeekSummaryNotification(pendingIntent, MainActivity.countNumberOfWorkThisWeek());
        NotificationScheduler.scheduleWeeklyReportJob(getApplicationContext());
        return true;
    }
